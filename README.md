...
- Adjust brightness
- Advanced batch editing via [EdiBatPlus UI](EdiBatPlusUI/index.html)
...
Open `index.html` in a browser to start editing. Use the **Batch Process** button to launch the EdiBatPlus batch editor.